...
export function AboutHero() {
  return (
    <section className="section-container relative overflow-hidden pt-10 sm:pt-14">
      ...
      <div className="grid items-center gap-8 lg:gap-10 xl:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="card card-glow-hover relative mx-auto w-full max-w-xl overflow-hidden xl:mx-0">
